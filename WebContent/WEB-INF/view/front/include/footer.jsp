...
<div class="mask hidden" id="loginDiv">
	...
	<div class="mask_content">
		...
		<!-- footer.jsp中进行登陆操作,登录界面 -->
		<div class="mask_content_body">
			<!-- 登陆后提交loginForm表单,URL为front/user/login.do,方式为post -->
			<form id="loginForm" action="front/user/login.do" method="post">
				<h3>快速登录</h3>
				<input type="email" value="875654381@qq.com" id="loginEmail" placeholder="请输入邮箱" name="email">
				<input type="password" value="111111" id="loginPassword" placeholder="请输入密码" name="password">
				<div id="forget">
	...
	<div class="mask_content">
		...
		<div class="mask_content_body">
			...
			<form id="regForm" action="front/user/regist.do" method="post">
				<h3>新用户注册</h3>
				<input type="email" value="875654381@qq.com" id="regEmail" placeholder="请输入邮箱" name="email">
				<input type="password" value="111111" id="regPsw" placeholder="请输入密码" name="password">
				<input type="password" value="111111" id="regPswAgain" placeholder="请再次输入密码" name="pswAgain">
