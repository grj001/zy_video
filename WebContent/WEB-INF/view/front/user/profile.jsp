                    ...
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                            ...
                            <c:if test="${not empty sessionScope.user.headUrl}">
                                <img width="200px" height="200px" src="/pic/${sessionScope.user.headUrl}">
                            </c:if>
                        </div>
                        <div class="profile_ifo_area">
                            <form action="front/user/profile.do" method="post">
                                ...
                                <div class="form_group">
                                    ...
                                    <input type="date"  name="birthdayStr" value='<fmt:formatDate value="${user.birthday}" type="both" pattern="yyyy-MM-dd"/>'>
                                </div>
                                <div class="form_group">
                                    <span class="dd">邮&#x3000;箱：</span>
                                    <span >${user.email}</span>
                                    <!-- 用户登陆时将user信息放入Session中 -->
