...
<body>
	<form class="form-horizontal container"
		action="<c:url value="/admin/video/addVideo.do"/>" method="post">
		<div class="container">
			<div class="jumbotron">
				<h2>添加视频信息-视频管理</h2>
			</div>
		...
		<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="text" name="videoTitle" class="form-control" id="inputEmail3" placeholder="">
				</div>
				<br />
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-10 col-lg-10 ">
					<input type="text" name="videoLength" class="form-control" id="inputEmail3" placeholder="">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-10 col-lg-10 ">
					<input type="text" name="videoImageUrl" class="form-control" id="inputEmail3" placeholder="">
				</div>
				<br />
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-10 col-lg-10 ">
					<input type="text" name="videoUrl" class="form-control" id="inputEmail3" placeholder="">
				</div>
				<br />
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-10 col-lg-10 ">
					<textarea class="form-control" name="videoDescr"></textarea>
				</div>
				<br />
			</div>
